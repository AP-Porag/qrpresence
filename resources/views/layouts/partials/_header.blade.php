...
{{--                    <img class="rounded-circle header-profile-user" src="" alt="Avatar">--}}
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    @if(auth()->user()->user_type == \App\Models\User::USER_TYPE_INSTRUCTOR)
                        <a class="dropdown-item" href="{{ route('instructor.profile.info')}}">
                            <i class="mdi mdi-account-circle font-size-17 align-middle me-1"></i>
                            Profile
                        </a>
                    @endif

                    @if(auth()->user()->user_type == \App\Models\User::USER_TYPE_STUDENT)
                        <a class="dropdown-item" href="{{ route('student.profile.info')}}">
                            <i class="mdi mdi-account-circle font-size-17 align-middle me-1"></i>
                            Profile
                        </a>
                    @endif
